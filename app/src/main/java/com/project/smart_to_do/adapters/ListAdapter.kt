package com.project.smart_to_do.adapters
...
import com.project.smart_to_do.fragments.bins.TrashBinFragmentDirections
import com.project.smart_to_do.fragments.list.ListFragmentDirections
import com.project.smart_to_do.utils.DateFormatUtil
import com.project.smart_to_do.utils.TaskDiffUtil
import java.util.*


class ListAdapter(
    val onCLick: (com.project.smart_to_do.data.Task) -> Unit

) : RecyclerView.Adapter<ListAdapter.ViewHolder>() {

    private var tasks = mutableListOf<com.project.smart_to_do.data.Task>()
